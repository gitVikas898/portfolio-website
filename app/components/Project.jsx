  ...
  return (
    <div id='projects'  className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  my-10 gap-5'>
            ...
            <a className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500' href="">Show more <Image src={assets.right_arrow_bold} alt='right arrow' className='w-4'/></a>
    </div>
  )
}
